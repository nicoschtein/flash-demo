...
const transfer = require("./node_modules/iota.flash.js/lib/transfer")
const multisig = require("./node_modules/iota.flash.js/lib/multisig")
...
const CHANNEL_BALANCE = DEPOSITS.reduce (function(accumulator, currentValue) {
